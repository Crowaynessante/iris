...
class PdfViewerComponent {
    ...
    if (this.options.showToolbar) {
      ...
      this.toolbarEl.innerHTML = `
        ...
        <div class="pdf-tb-right">
          <button type="button" class="pdf-btn mode-btn active" id="pdfBtnContinuousMode" title="Continuous Scroll Mode"><i class="fa-solid fa-scroll" aria-hidden="true"></i></button>
          <button type="button" class="pdf-btn mode-btn" id="pdfBtnSingleMode" title="Single Page Mode"><i class="fa-solid fa-file-lines" aria-hidden="true"></i></button>
  ...
  showCopyFeedback(text) {
    ...
    feedbackEl.textContent = `<i class="fa-solid fa-check" aria-hidden="true"></i> Selected: "${preview}"`;
  ...
  showErrorState(errMsg) {
    ...
    this.pagesStackEl.innerHTML = `
      <div class="pdf-error-state">
        <span style="font-size: 1.8rem; margin-bottom: 0.5rem; display: block;"><i class="fa-solid fa-triangle-exclamation" aria-hidden="true"></i></span>
