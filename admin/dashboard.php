...
<body class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex flex-col">
    ...
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-50 backdrop-blur-md bg-opacity-90 dark:bg-opacity-90">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-3">
                    <a href="../user/dashboard.php" class="hidden sm:inline-flex items-center px-3.5 py-2 text-xs font-semibold text-emerald-700 bg-emerald-50 dark:bg-gray-700 dark:text-emerald-300 hover:bg-emerald-100 rounded-lg transition-colors border border-emerald-200 dark:border-emerald-800">
                    ...
                    <div class="relative">
                        <button type="button" class="flex items-center space-x-2 text-sm bg-gray-100 dark:bg-gray-700 p-1.5 rounded-full focus:ring-4 focus:ring-emerald-300 dark:focus:ring-emerald-800" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                            ...
                            <span class="hidden sm:inline-block font-medium text-xs px-1 text-gray-700 dark:text-gray-200"><?= htmlspecialchars($_SESSION['username']) ?></span>
                        </button>
                        <!-- Dropdown Menu -->
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-xl shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                            <div class="px-4 py-3">
                                <span class="block text-sm font-semibold text-gray-900 dark:text-white"><?= htmlspecialchars($_SESSION['username']) ?></span>
                            ...
                            <ul class="py-2" aria-labelledby="user-menu-button">
                                <li>
                                    <a href="../user/dashboard.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200">
                                        <i class="fa-solid fa-globe mr-2"></i> Observatory View
                                    </a>
                                </li>
                            </ul>
                            <div class="py-1">
                                <a href="../auth/logout.php" class="block px-4 py-2 text-sm text-red-600 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-red-400">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex-1 w-full space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="p-6 bg-white dark:bg-gray-800 rounded-2xl border-2 border-emerald-500/40 dark:border-emerald-500/30 shadow-md relative flex flex-col justify-between overflow-hidden">
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                    <a href="smart_upload.php" class="inline-flex items-center justify-center w-full px-4 py-2.5 text-sm font-semibold text-white bg-emerald-600 hover:bg-emerald-500 rounded-xl shadow transition-colors">
        ...
        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm space-y-6" id="direct-csv">
            ...
            <form action="upload_process.php" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-100 dark:border-gray-700 text-xs text-gray-600 dark:text-gray-300 space-y-1.5">
                ...
                <div class="pt-2 text-gray-500 dark:text-gray-400 italic">
                    * For SDG breakdowns, WURI categories, or AUN-QA accreditations, use <a href="smart_upload.php" class="text-emerald-600 dark:text-emerald-400 font-semibold underline">Smart Upload</a>.
                </div>
            </div>
        </div>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        while ($row = mysqli_fetch_assoc($logs)):
                            $hasLogs = true;
                            $fileType = $row['file_type'] ? strtoupper($row['file_type']) : 'CSV';
                        ?>
